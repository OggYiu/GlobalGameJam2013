 ...
 */
 class ResourceLoader implements MSpriteImageLoader {
	 ...
	 */
	public function loadImage( spriteName:String, imageId:Int, orientationUsedInStudio:Int ) : Array<BitmapData> {
	 ...
	 */
	public function loadImageClip( spriteName:String, imageId:Int , x:Int, y:Int, w:Int, h:Int, orientationUsedInStudio:Int ) : Array<BitmapData> {
		...
		var origImage : BitmapData =  nme.Assets.getBitmapData( "assets/motionwelder/" + spriteName + ".png" );
